...
function renderLicenseBadge(license) {
  if (license === 'None') return ""
    ...
    // Variable to house licenses and their respective badges and links to license description
    const licenses = [
    ...
    // Loop to go over all licenses and their badges and return badge value of the license selected by user
...
function renderLicenseLink(license) {
  if (license === 'None') return ""
    ...
    // Variable to house licenses and their respective links to license description
    const licenses = [
  ...
  // Loop to go over all licenses and their links and return link value of the license selected by user
